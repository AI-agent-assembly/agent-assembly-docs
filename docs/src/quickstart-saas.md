...
> 🗺️ **Planned — not available.** The AI Agent Assembly managed SaaS platform has
> no public signup, no published plans or prices, and no service commitments.
> Nothing on this page is purchasable or usable today, and nothing here is an
> offer, a quote, or a contractual commitment.
...
| Read the policy rule schema the gateway enforces | [Policy reference](policy-reference.md) |
...
- [Cloud deployment](cloud-deployment.md) — the managed control plane, also planned
